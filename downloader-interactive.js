#!/usr/bin/env node
/**
 * USDZ Interactive Downloader - Download and delete 3D assets from Hunyuan
 * Keeps browser visible and waits for user to verify login before proceeding
 */
...
async function runAutomation() {
  ...
  try {
    ...
    console.log('\n[AUTH] Browser is open. Please verify you are logged in.');
    ...
    console.log('[Auth] Starting automation...\n');
